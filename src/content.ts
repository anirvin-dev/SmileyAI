...
// Define the type for our toast element
interface ToastElement extends HTMLElement {
  autoDismissTimeout?: number;
}

// Listen for messages from the background script
chrome.runtime.onMessage.addListener((request: { action: string; message: string }, sender, sendResponse) => {
...
function startAutoDismissTimer(toast: ToastElement): void {
...
function dismissToast(toast: ToastElement): void {
